...
<@block name="titile">
    <title>后台管理-首页</title>
    <meta name="keywords" content="后台管理--首页">
    <meta name="description" content="后台管理-首页">
</@block>
    ...
    <link href="${baseUrl}v2.0/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <link href="${baseUrl}v2.0/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body>
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="${baseUrl}v2.0/img/profile_small.jpg" />
                             </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="index.ftl#">
                                <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">${user_login}</strong>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="${baseUrl}user/exit">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="active">
                        <a href="${baseUrl}index/home/"><i class="fa fa-th-large"></i> <span class="nav-label">主页</span> <span class="fa arrow"></span></a>
                        
                        
                    </li>
                           
                    <li>
                        <a href="index.ftl#"><i class="fa fa fa-globe"></i> <span class="nav-label">任务管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="${baseUrl}task/home">新建任务</a>
                            </li>
                            <li><a href="${baseUrl}task/page">任务列表</a>
                            </li>
                       </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message"><a href="${baseUrl}index/home/" title="返回首页"><i class="fa fa-home"></i></a>后台管理</span>
                        </li>
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="${baseUrl}index/home/">
            ...
            <@block name="wrapper wrapper-content">
    ...
    <!-- Flot -->
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/flot/jquery.flot.symbol.js"></script>

    <!-- Peity -->
    <script src="${baseUrl}v2.0/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${baseUrl}v2.0/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="${baseUrl}v2.0/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="${baseUrl}v2.0/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${baseUrl}v2.0/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="${baseUrl}v2.0/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="${baseUrl}v2.0/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="${baseUrl}v2.0/js/demo/sparkline-demo.js"></script>
